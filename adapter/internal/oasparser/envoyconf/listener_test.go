...
func testCreateRoutesForUnitTests(t *testing.T) []*routev3.Route {
	...
	route1, _ := createRoute(generateRouteCreateParamsForUnitTests("test", "HTTP", "localhost", "/test", "1.0.0", "/test",
		"/testPath", []string{"GET"}, "test-cluster", corsConfigModel3))
	route2, _ := createRoute(generateRouteCreateParamsForUnitTests("test", "HTTP", "localhost", "/test", "1.0.0", "/test",
		"/testPath", []string{"POST"}, "test-cluster", corsConfigModel3))
	route3, _ := createRoute(generateRouteCreateParamsForUnitTests("test", "HTTP", "localhost", "/test", "1.0.0", "/test",
