...
public const string PERSISTENT_MESSAGE_PILOT_INSTANCE_ID = "tokenRevocationConfig.persistent.pilot";
public const string PERSISTENT_MESSAGE_PILOT_ENABLED = "enablePersistentStorageRetrieval";
public const string PERSISTENT_MESSAGE_PILOT_REVOKED_TOKEN_RETRIEVAL_ENDPOINT = "revokedTokenRetrievalEndpoint";
public const string PERSISTENT_MESSAGE_PILOT_USERNAME = "username";
public const string PERSISTENT_MESSAGE_PILOT_PASSWORD = "password";
...
public const string REVOKED_TOKEN_RETRIEVE_UTIL = "RevokedTokenRetrieveUtil";
