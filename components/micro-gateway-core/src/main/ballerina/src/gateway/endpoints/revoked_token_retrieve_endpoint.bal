...
http:Client revokeTokenRetrieveEndpoint = new (getConfigValue(PERSISTENT_MESSAGE_PILOT_INSTANCE_ID,
    PERSISTENT_MESSAGE_PILOT_REVOKED_TOKEN_RETRIEVAL_ENDPOINT,
    DEFAULT_PERSISTENT_MESSAGE_PILOT_REVOKED_TOKEN_RETRIEVE_ENDPOINT),
{
    cache: {enabled: false},
    secureSocket: {
        trustStore: {
