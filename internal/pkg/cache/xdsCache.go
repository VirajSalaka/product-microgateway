...
// //
// // Logger is optional.
// func NewSnapshotCache(ads bool, hash cachev3.NodeHash, logger log.Logger) cachev3.SnapshotCache {
...
// func (cache *snapshotCache) SetSnapshot(node string, snapshot cachev3.Snapshot) error {
// 	cache.mu.Lock()
...
// func (cache *snapshotCache) GetSnapshot(node string) (cachev3.Snapshot, error) {
// 	cache.mu.RLock()
...
// func (cache *snapshotCache) CreateWatch(request *cachev3.Request) (chan cachev3.Response, func()) {
...
// func (cache *snapshotCache) respond(request *cachev3.Request, value chan cachev3.Response, resources map[string]types.Resource, version string) {
...
// func createResponse(request *cachev3.Request, resources map[string]types.Resource, version string) cachev3.Response {
